...
void test_cusparseSpSM() {
  ...
  */
  ...
  void* dBuffer_c = NULL;
  void* dBuffer_z = NULL;
  dBuffer_s = (void *)sycl::malloc_device(bufferSize_s, q_ct1);
  dBuffer_d = (void *)sycl::malloc_device(bufferSize_d, q_ct1);
  dBuffer_c = (void *)sycl::malloc_device(bufferSize_c, q_ct1);
  dBuffer_z = (void *)sycl::malloc_device(bufferSize_z, q_ct1);
  ...
  */
  ...
  dpct::dpct_free(dBuffer_s, q_ct1);
  dpct::dpct_free(dBuffer_d, q_ct1);
  dpct::dpct_free(dBuffer_c, q_ct1);
  dpct::dpct_free(dBuffer_z, q_ct1);
